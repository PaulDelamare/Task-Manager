...
export default function AnimatedCheckbox({ checked = false, onChange, ariaLabel }: { checked?: boolean; onChange?: () => void; ariaLabel?: string }) {
    return (
        <label className="container">
            <input checked={checked} onChange={onChange} aria-label={ariaLabel} type="checkbox" />
